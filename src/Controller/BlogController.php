...
class BlogController extends BaseController
{
    ...
    public function groupAction(Request $request)
    {
        ...
        if ('desactiver' == $action && $this->isGranted('ROLE_EDITORIAL')) {
        ...
        } elseif ('activer' == $action && $this->isGranted('ROLE_EDITORIAL')) {
            foreach ($bloPosts as $blogPost) {
        ...
        } elseif ('supprimer' == $action && $this->isGranted('ROLE_EDITORIAL')) {
            foreach ($bloPosts as $blogPost) {
